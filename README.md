...
[Пример слова с применением правил 1) и 4)](Lab1/image_tree/tree_4.png)
...
Оставлены исходные правила переписывания (1-10). Теперь число классов эквивалентности вида b, bb, bbb etc. не должно быть бесконечным.
...
1) Количество $\{c}$ никогда не увеличивается и может уменьшаться. (нарушается из-за правила ba->c.) Инвариант был проверен в коде.
2) Сумма букв $\{a+c}$ не возрастает. Инвариант был проверен в коде.
3) Максимальная позиция символа $\{c}$ в слове не возрастает. Т.е. символ $\{c}$ не сдвигается вправо (нарушается из-за правила cb->bc)
...
5) Минимальная позиция символа $\{a}$ не возрастает. Т.е. символ $\{a}$ не сдвигается вправо. Инвариант был проверен в коде.
